...
//            circles[i].setFrontImage("Project/res/objects/dragon.png");
//            // Randomly select and set back image for each circle
//            Random random = new Random();
//            int randomNumber = random.nextInt(availableImages.size());
//            String backImagePath = availableImages.get(randomNumber);
//            circles[i].setBackImage(backImagePath, randomNumber);
//        }
//    }
    private void initializeCircles() {
        int centerX = getWidth() / 2;
