...
/**
 * Represents a card that depicts a bat.
 * Extends the DragonCard class and provides specific functionality for a bat card.
 */
public class BatCard extends DragonCard {

    /**
     * Constructs a new BatCard with the specified coordinates.
     *
    ...
    /**
     * Draws the bat card on the graphics context.
     *
     * @param g2d The graphics context on which to draw the card.
     */
    @Override
    public void draw(Graphics2D g2d) {
        // Custom drawing logic for the bat card
    }

    /**
     * Handles the mouseClicked event for the bat card.
