...
/**
 * Represents a card that depicts a pirate.
 * Extends the DragonCard class and provides specific functionality for a pirate card.
 */
public class PirateCard extends DragonCard {

    /**
     * Constructs a new PirateCard with the specified coordinates.
     *
    ...
    /**
     * Draws the pirate card on the graphics context.
     *
     * @param g2d The graphics context on which to draw the card.
     */
    @Override
    public void draw(Graphics2D g2d) {
        // Custom drawing logic for the pirate card
    }

    /**
     * Handles the mouseClicked event for the pirate card.
